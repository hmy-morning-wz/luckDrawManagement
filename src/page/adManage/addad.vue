      ...
      >
        <div style="display:flex">
          <el-form-item label="广告位类型" required>
            <el-select v-model="ruleForm.position" :disabled="type" placeholder="请选择">
              <el-option
          ...
          <el-form-item label="关联活动" v-if="ruleForm.position=='1'">
            <el-select v-model="ruleForm.activity_id" :disabled="type" placeholder="请选择">
              <el-option
        ...
        <div v-if="ruleForm.position=='2'">
          ...
          <div style="display:flex">
            <el-form-item label="是否置顶" v-if="ruleForm.position==2" prop="is_top">
              <el-radio v-model="ruleForm.is_top" :label="1" :disabled="type">是</el-radio>
              <el-radio v-model="ruleForm.is_top" :label="0" :disabled="type">否</el-radio>
            </el-form-item>
          </div>
        </div>
    ...
    submitForm(formName) {
      ...
      this.$refs[formName].validate(valid => {
        if (valid) {
            ...
            console.log(data)
            adService.addAdsense(data).then(
              response => {
                this.$message({
                  message: '创建成功',
                  type: 'success'
