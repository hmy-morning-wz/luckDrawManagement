      ...
      >
        ...
        <div style="display:flex" >
          <el-form-item label="奖品1类型" required>
            <el-select v-model="ruleForm.award.type" :disabled="type" placeholder="请选择">
              <el-option
          ...
          <el-form-item label="奖品选择" v-if="ruleForm.award.type==1">
            <el-select v-model="ruleForm.award.lottery_id" :disabled="type" placeholder="请选择">
              <el-option
          ...
          <el-form-item label="乘车券id" v-if="ruleForm.award.lottery_id===-1 && ruleForm.award.type==1">
            <el-input v-model="ruleForm.award.bus_coupon_template_id" class="w200" :disabled="type" placeholder="选择乘车券"></el-input>
          </el-form-item>
        </div>

        <div v-if="ruleForm.award.lottery_id===-2 && ruleForm.award.type==1" style="display:flex" >
        ...
        <div style="display:flex" >
          <el-form-item label="奖品2类型">
            <el-select v-model="ruleForm.award2.type" :disabled="type" placeholder="请选择">
              <el-option
                v-for="item in options2"
                :key="item.value"
                :label="item.label"
          ...
          <el-form-item label="奖品选择" v-if="ruleForm.award2.type==1">
            <el-select v-model="ruleForm.award2.lottery_id" :disabled="type" placeholder="请选择">
              <el-option
                v-for="item in prizeList"
                :key="item.id"
                :label="item.name"
          ...
          <el-form-item label="乘车券id" v-if="ruleForm.award2.lottery_id===-1 && ruleForm.award2.type==1">
            <el-input v-model="ruleForm.award2.bus_coupon_template_id" class="w200" :disabled="type" placeholder="选择乘车券"></el-input>
          </el-form-item>
        </div>

        <div v-if="ruleForm.award2.lottery_id===-2 && ruleForm.award2.type==1" style="display:flex" >
          <el-form-item label="中奖码">
            <el-input
                style="width:30vw"
                type="textarea"
        ...
        <div style="display:flex">
          ...
          <el-form-item label="开奖类型" required class="mlminus30">
            <el-select v-model="ruleForm.limit_type" :disabled="type" placeholder="请选择">
              <el-option
          ...
          <el-form-item v-if="ruleForm.limit_type==1" label="开奖人数" class="mlminus50" prop="award.num">
            <el-input v-model="ruleForm.limit_num" class="w100" :disabled="type" placeholder="中奖人数"></el-input>
          </el-form-item>
          <el-form-item required label="开始时间" class="mlminus50" prop="start_time">
            <el-date-picker
        ...
        <div style="display:flex">
          <el-form-item label="奖池是否配置" required prop="is_pond">
            <el-radio v-model="ruleForm.is_pond" :label="1" :disabled="type" @change="isSetPond">是</el-radio>
            <el-radio v-model="ruleForm.is_pond" :label="0" :disabled="type" @change="isSetPond">否</el-radio>
          </el-form-item>
          <el-form-item label="是否随机瓜分奖池" required prop="is_pond">
            <el-radio v-model="ruleForm.is_random" :label="1" :disabled="type||(ruleForm.is_pond===0)">是</el-radio>
            <el-radio v-model="ruleForm.is_random" :label="0" :disabled="type||(ruleForm.is_pond===0)">否</el-radio>
          </el-form-item>
        </div>

        <div style="display:flex">
          <el-form-item label="奖池初始金额" prop="pond_amt">
            <el-input v-model="ruleForm.pond_amt" class="w200"
            placeholder="奖池初始金额" :disabled="type||(ruleForm.is_pond===0)">
            </el-input>
          </el-form-item>
          <el-form-item label="奖池上线金额" prop="pond_amt_limit">
            <el-input v-model="ruleForm.pond_amt_limit" class="w200"
            placeholder="奖池上线金额" :disabled="type||(ruleForm.is_pond===0)"></el-input>
          </el-form-item>  
        </div>      
        
        <div style="display:flex">
          <el-form-item label="奖池中奖比例" prop="pond_prod">
            <el-input v-model="ruleForm.pond_prod" class="w200"
            placeholder="中奖百分比，1-100" :disabled="type||(ruleForm.is_pond===0)"></el-input>
          </el-form-item>
...
export default {
  ...
  methods: {
    ...
    submitForm(formName) {
      ...
      console.log('br'+this.ruleForm.note.slice(-8,-4))
      ...
      if(this.ruleForm.start_time) this.ruleForm.start_time = moment(this.ruleForm.start_time).formats()
      ...
      this.$refs[formName].validate(valid => {
        if (valid) {
          if(this.ruleForm.award.type === ''){
            ...
            delete data.award2
            console.log(data)
            activityService.addLottery(data).then(
              response => {
                this.$message({
                  message: '创建成功',
                  type: 'success'
